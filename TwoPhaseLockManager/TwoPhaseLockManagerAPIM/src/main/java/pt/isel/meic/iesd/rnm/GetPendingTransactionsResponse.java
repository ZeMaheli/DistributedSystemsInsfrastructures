...
/**
 * <p>Java class for getPendingTransactionsResponse complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="getPendingTransactionsResponse">
 *   <complexContent>
...
@XmlType(name = "getPendingTransactionsResponse", propOrder = {
    "_return"
})
